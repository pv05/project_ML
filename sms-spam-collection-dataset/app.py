...
tfidf = pickle.load(open('/pv05/project_ML/blob/main/sms-spam-collection-dataset/vectorizer.pkl','rb'))
model = pickle.load(open('/pv05/project_ML/blob/main/sms-spam-collection-dataset/model.pkl','rb'))
